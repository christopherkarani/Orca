...
Required fake/simulation fixtures are counted by CI. PX4 and ArduPilot SITL
fixtures are optional and skip unless an explicit SITL workflow enables them.
