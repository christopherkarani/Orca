...
- MAVLink coverage is bounded to supported message and command surfaces.
- Customer-specific modes, custom dialects, and companion-computer behavior require explicit review.
- No hosted telemetry, SaaS control plane, billing, or license enforcement is included in this pilot package.
