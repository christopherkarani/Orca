...
pub fn writeDoctor(writer: anytype, options: DoctorOptions) !void {
    ...
    try writer.writeAll("SITL integration tests: opt-in with AEGIS_EDGE_RUN_ARDUPILOT_SITL_TESTS=1, AEGIS_EDGE_ARDUPILOT_ENDPOINT, and AEGIS_EDGE_ARDUPILOT_VEHICLE\n");
