#!/bin/bash
#
# End-to-End Test Script for `orca scan --staged`
#
...
#   - Runs `orca scan --staged` and asserts correct output/exit code
#
# Usage:
...
echo -e "${BOLD}${BLUE}orca scan --staged E2E Test Suite${NC}"
