//! Benchmark comparing regex crate vs regex-automata for orca patterns.
//!
...
/// Representative patterns from orca packs (from most common to least common)
...
fn bench_multi_pattern(c: &mut Criterion) {
    ...
    // Sequential scan (current orca approach)
