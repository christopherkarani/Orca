...
/// Orca-rs tool information URI.
pub const ORCA_INFO_URI: &str = crate::branding::GITHUB_REPO_URL;
            ...
            rules_map
                ...
                .or_insert_with(|| SarifReportingDescriptor {
                    ...
                    help_uri: Some(format!(
                        "https://github.com/christopherkarani/Orca/blob/main/docs/rules/{}.md",
                        rule_id.replace([':', '.'], "/")
                    )),
            ...
            runs: vec![SarifRun {
                tool: SarifTool {
                    driver: SarifToolComponent {
                        name: crate::branding::CLI_NAME.to_string(),
                        version: Some(version.to_string()),
                        semantic_version: Some(version.to_string()),
                        information_uri: Some(ORCA_INFO_URI.to_string()),
                        rules,
                    },
                },
                results,
