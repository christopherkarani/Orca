//! Standardized error codes for Orca-rs.
//!
//! This module provides a consistent error code system for all Orca-rs operations.
//! Error codes follow the format `ORCA-XXXX` where:
//!
//! - ORCA-1xxx: Pattern matching errors
//! - ORCA-2xxx: Configuration errors
//! - ORCA-3xxx: Runtime errors
//! - ORCA-4xxx: External integration errors
//!
//! # Example
//!
//! ```ignore
//! use orca_rs::error_codes::{OrcaError, ErrorCode};
//!
//! let error = OrcaError::pattern_compile_failed("core.git", "invalid regex: [");
...
/// Error categories for Orca-rs operations.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum ErrorCategory {
    /// Pattern matching and evaluation errors (ORCA-1xxx)
    PatternMatch,
    /// Configuration loading and parsing errors (ORCA-2xxx)
    Configuration,
    /// Runtime and execution errors (ORCA-3xxx)
    Runtime,
    /// External integration errors (ORCA-4xxx)
    External,
}
...
pub enum ErrorCode {
    ...
    // ORCA-1xxx: Pattern Matching Errors
    // ===========================================
    /// ORCA-1001: Pattern compilation failed
    #[serde(rename = "ORCA-1001")]
    PatternCompileFailed,

    /// ORCA-1002: Pattern match timeout
    #[serde(rename = "ORCA-1002")]
    PatternMatchTimeout,

    /// ORCA-1003: Invalid pattern syntax
    #[serde(rename = "ORCA-1003")]
    InvalidPatternSyntax,

    /// ORCA-1004: Pattern evaluation error
    #[serde(rename = "ORCA-1004")]
    PatternEvaluationError,

    /// ORCA-1005: Quick reject filter error
    #[serde(rename = "ORCA-1005")]
    QuickRejectError,

    /// ORCA-1006: Safe pattern mismatch
    #[serde(rename = "ORCA-1006")]
    SafePatternMismatch,

    /// ORCA-1007: Destructive pattern match
    #[serde(rename = "ORCA-1007")]
    DestructivePatternMatch,

    /// ORCA-1008: Pack pattern not found
    #[serde(rename = "ORCA-1008")]
    PackPatternNotFound,

    /// ORCA-1009: Heredoc extraction failed
    #[serde(rename = "ORCA-1009")]
    HeredocExtractionFailed,

    /// ORCA-1010: AST matching error
    #[serde(rename = "ORCA-1010")]
    AstMatchingError,

    // ===========================================
    // ORCA-2xxx: Configuration Errors
    // ===========================================
    /// ORCA-2001: Configuration file not found
    #[serde(rename = "ORCA-2001")]
    ConfigFileNotFound,

    /// ORCA-2002: Configuration parse error
    #[serde(rename = "ORCA-2002")]
    ConfigParseError,

    /// ORCA-2003: Invalid configuration value
    #[serde(rename = "ORCA-2003")]
    InvalidConfigValue,

    /// ORCA-2004: Allowlist load error
    #[serde(rename = "ORCA-2004")]
    AllowlistLoadError,

    /// ORCA-2005: Invalid allowlist entry
    #[serde(rename = "ORCA-2005")]
    InvalidAllowlistEntry,

    /// ORCA-2006: Pack configuration error
    #[serde(rename = "ORCA-2006")]
    PackConfigError,

    /// ORCA-2007: Pack not found
    #[serde(rename = "ORCA-2007")]
    PackNotFound,

    /// ORCA-2008: Invalid rule ID format
    #[serde(rename = "ORCA-2008")]
    InvalidRuleIdFormat,

    /// ORCA-2009: Duplicate rule ID
    #[serde(rename = "ORCA-2009")]
    DuplicateRuleId,

    /// ORCA-2010: Settings file error
    #[serde(rename = "ORCA-2010")]
    SettingsFileError,

    // ===========================================
    // ORCA-3xxx: Runtime Errors
    // ===========================================
    /// ORCA-3001: JSON parse error
    #[serde(rename = "ORCA-3001")]
    JsonParseError,

    /// ORCA-3002: IO error
    #[serde(rename = "ORCA-3002")]
    IoError,

    /// ORCA-3003: Timeout exceeded
    #[serde(rename = "ORCA-3003")]
    TimeoutExceeded,

    /// ORCA-3004: Memory limit exceeded
    #[serde(rename = "ORCA-3004")]
    MemoryLimitExceeded,

    /// ORCA-3005: Invalid input
    #[serde(rename = "ORCA-3005")]
    InvalidInput,

    /// ORCA-3006: Hook protocol error
    #[serde(rename = "ORCA-3006")]
    HookProtocolError,

    /// ORCA-3007: Stdin read error
    #[serde(rename = "ORCA-3007")]
    StdinReadError,

    /// ORCA-3008: Stdout write error
    #[serde(rename = "ORCA-3008")]
    StdoutWriteError,

    /// ORCA-3009: File scan error
    #[serde(rename = "ORCA-3009")]
    FileScanError,

    /// ORCA-3010: Database error
    #[serde(rename = "ORCA-3010")]
    DatabaseError,

    // ===========================================
    // ORCA-4xxx: External Integration Errors
    // ===========================================
    /// ORCA-4001: External pack load failed
    #[serde(rename = "ORCA-4001")]
    ExternalPackLoadFailed,

    /// ORCA-4002: External pack parse error
    #[serde(rename = "ORCA-4002")]
    ExternalPackParseError,

    /// ORCA-4003: Network request failed
    #[serde(rename = "ORCA-4003")]
    NetworkRequestFailed,

    /// ORCA-4004: Version check failed
    #[serde(rename = "ORCA-4004")]
    VersionCheckFailed,

    /// ORCA-4005: MCP protocol error
    #[serde(rename = "ORCA-4005")]
    McpProtocolError,

    /// ORCA-4006: Hook integration error
    #[serde(rename = "ORCA-4006")]
    HookIntegrationError,

    /// ORCA-4007: Git operation failed
    #[serde(rename = "ORCA-4007")]
    GitOperationFailed,

    /// ORCA-4008: Claude Code hook error
    #[serde(rename = "ORCA-4008")]
    ClaudeCodeHookError,

    /// ORCA-4009: External command execution failed
    #[serde(rename = "ORCA-4009")]
    ExternalCommandFailed,

    /// ORCA-4010: API rate limit exceeded
    #[serde(rename = "ORCA-4010")]
    ApiRateLimitExceeded,
}

impl ErrorCode {
    /// Get the numeric code as a string (e.g., "ORCA-1001").
    #[must_use]
    pub const fn as_str(&self) -> &'static str {
        match self {
            // Pattern matching errors
            Self::PatternCompileFailed => "ORCA-1001",
            Self::PatternMatchTimeout => "ORCA-1002",
            Self::InvalidPatternSyntax => "ORCA-1003",
            Self::PatternEvaluationError => "ORCA-1004",
            Self::QuickRejectError => "ORCA-1005",
            Self::SafePatternMismatch => "ORCA-1006",
            Self::DestructivePatternMatch => "ORCA-1007",
            Self::PackPatternNotFound => "ORCA-1008",
            Self::HeredocExtractionFailed => "ORCA-1009",
            Self::AstMatchingError => "ORCA-1010",
            // Configuration errors
            Self::ConfigFileNotFound => "ORCA-2001",
            Self::ConfigParseError => "ORCA-2002",
            Self::InvalidConfigValue => "ORCA-2003",
            Self::AllowlistLoadError => "ORCA-2004",
            Self::InvalidAllowlistEntry => "ORCA-2005",
            Self::PackConfigError => "ORCA-2006",
            Self::PackNotFound => "ORCA-2007",
            Self::InvalidRuleIdFormat => "ORCA-2008",
            Self::DuplicateRuleId => "ORCA-2009",
            Self::SettingsFileError => "ORCA-2010",
            // Runtime errors
            Self::JsonParseError => "ORCA-3001",
            Self::IoError => "ORCA-3002",
            Self::TimeoutExceeded => "ORCA-3003",
            Self::MemoryLimitExceeded => "ORCA-3004",
            Self::InvalidInput => "ORCA-3005",
            Self::HookProtocolError => "ORCA-3006",
            Self::StdinReadError => "ORCA-3007",
            Self::StdoutWriteError => "ORCA-3008",
            Self::FileScanError => "ORCA-3009",
            Self::DatabaseError => "ORCA-3010",
            // External integration errors
            Self::ExternalPackLoadFailed => "ORCA-4001",
            Self::ExternalPackParseError => "ORCA-4002",
            Self::NetworkRequestFailed => "ORCA-4003",
            Self::VersionCheckFailed => "ORCA-4004",
            Self::McpProtocolError => "ORCA-4005",
            Self::HookIntegrationError => "ORCA-4006",
            Self::GitOperationFailed => "ORCA-4007",
            Self::ClaudeCodeHookError => "ORCA-4008",
            Self::ExternalCommandFailed => "ORCA-4009",
            Self::ApiRateLimitExceeded => "ORCA-4010",
        }
    }
    ...
    /// Get the numeric code value (e.g., 1001 for ORCA-1001).
    #[must_use]
...
/// A structured ORCA error with code, category, message, and context.
///
/// This is the standard error format for JSON output from ORCA commands.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct OrcaError {
    /// The error code (e.g., "ORCA-1001")
    pub code: String,
...
impl ErrorResponse {
    ...
    #[must_use]
    pub const fn new(error: OrcaError) -> Self {
        Self { error }
    }
...
mod tests {
    ...
    fn test_error_code_as_str() {
        assert_eq!(ErrorCode::PatternCompileFailed.as_str(), "ORCA-1001");
        assert_eq!(ErrorCode::ConfigFileNotFound.as_str(), "ORCA-2001");
        assert_eq!(ErrorCode::JsonParseError.as_str(), "ORCA-3001");
        assert_eq!(ErrorCode::ExternalPackLoadFailed.as_str(), "ORCA-4001");
    }
    ...
    #[test]
    fn test_orca_error_creation() {
        let error = OrcaError::new(ErrorCode::JsonParseError, "unexpected end of input");
        assert_eq!(error.code, "ORCA-3001");
    ...
    #[test]
    fn test_orca_error_with_context() {
        let error = OrcaError::pattern_compile_failed("core.git:reset-hard", "invalid regex");
        assert_eq!(error.code, "ORCA-1001");
        assert_eq!(error.category, ErrorCategory::PatternMatch);
        assert!(error.context.contains_key("pattern_name"));
    }

    #[test]
    fn test_orca_error_json_serialization() {
        let error = OrcaError::json_parse_error("unexpected token");
        let json = error.to_json();
        assert!(json.contains("ORCA-3001"));
    ...
    fn test_error_response_json() {
        let error = OrcaError::config_not_found("/path/to/config.toml");
        let response = ErrorResponse::new(error);
        let json = response.to_json();
        assert!(json.contains("error"));
        assert!(json.contains("ORCA-2001"));
    }

    #[test]
    fn test_error_display() {
        let error = OrcaError::io_error("file read", "permission denied");
        let display = error.to_string();
        assert!(display.contains("[ORCA-3002]"));
