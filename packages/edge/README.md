...
- Runtime-health and watchdog commands for deterministic local checks, health scenarios, reports, and simulations.
- Honest `aegis-edge doctor`, `aegis-edge deployment`, `aegis-edge bench`, `aegis-edge schema`, `aegis-edge policy`, `aegis-edge safety`, `aegis-edge safety-case`, `aegis-edge replay`, `aegis-edge mavlink`, `aegis-edge px4`, `aegis-edge ardupilot`, `aegis-edge data`, `aegis-edge network`, `aegis-edge health`, and `aegis-edge watchdog` commands.
