...
Later phases may add simulation-only policy evaluation, bench validation, and adapter work. MAVLink, PX4, ArduPilot, and real-flight behavior remain out of scope for Phase 25.
