...
Initialize an Aegis policy with the Claude Code preset:
...
If the `claude-code` preset is not available in your Aegis build, use the closest plugin-safe preset:
