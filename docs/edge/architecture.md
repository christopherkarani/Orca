...
Agent / Companion Planner
    |
    v
Edge MAVLink Gateway
    |
    v
Autopilot or SITL
```

Edge mediates selected MAVLink commands before they reach a bridge. It does not replace the autopilot. PX4 and ArduPilot remain responsible for flight-control behavior in their own environments.
