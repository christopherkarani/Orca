...
Phase 27 enforces circular WGS84 geofences only. Phase 28 reuses that policy for supported fake MAVLink waypoint and setpoint mediation. The policy must include a center latitude/longitude, radius in meters, altitude floor/ceiling, explicit altitude reference, and boundary action.
...
- Mismatched altitude references fail explicitly. Aegis Edge does not convert AMSL, AGL, home-relative, or terrain-relative altitude in Phase 28.
