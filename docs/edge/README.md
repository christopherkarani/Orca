...
- [Command risk](command-risk.md)
- [State freshness](state-freshness.md)

## Architecture

- [Architecture](architecture.md)
- [MAVLink gateway](mavlink-gateway.md)
- [Deployment](deployment.md)
- [Runtime assets](runtime-assets.md)

## Safety Boundary

- [Simulation vs flight](simulation-vs-flight.md)
- [Limitations](limitations.md)
- [Bench safety boundary](bench-safety-boundary.md)
- [Hardware bench](hardware-bench.md)

## MAVLink Gateway

- [MAVLink gateway](mavlink-gateway.md)
- [Supported messages](mavlink-supported-messages.md)
- [MAVLink limitations](mavlink-limitations.md)
- [MAVLink simulation](mavlink-simulation.md)

## PX4 SITL

- [PX4 SITL](px4-sitl.md)
- [PX4 scenarios](px4-scenarios.md)
- [PX4 limitations](px4-limitations.md)

## ArduPilot SITL

- [ArduPilot SITL](ardupilot-sitl.md)
- [ArduPilot scenarios](ardupilot-scenarios.md)
- [ArduPilot limitations](ardupilot-limitations.md)

## Safety Enforcement

- [Flight safety enforcement](flight-safety-enforcement.md)
- [Geofence enforcement](geofence-enforcement.md)
- [Mission safety](mission-safety.md)
- [Altitude and velocity](altitude-velocity-enforcement.md)
- [Battery enforcement](battery-enforcement.md)

## Operator Approval

- [Operator approval](operator-approval.md)
- [Approval scopes](approval-scopes.md)

## Emergency Modes

- [Emergency modes](emergency-modes.md)
- [Emergency fallbacks](emergency-fallbacks.md)
- [Degraded modes](degraded-modes.md)

## Audit And Replay

- [Audit replay](audit-replay.md)
...
- [Customer safety reports](customer-safety-reports.md)
...
- [Fixtures](redteam-fixtures.md)
- [Scorecards](redteam-scorecards.md)
- [SITL red-team](sitl-redteam.md)
- [Customer red-team summary](customer-proof/redteam-summary.md)
...
- [Exfiltration detection](exfiltration-detection.md)
...
- [Audit health](audit-health.md)
- [Health red-team](health-redteam.md)

## Deployment And ARM64
