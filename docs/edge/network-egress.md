...
Use `edge network explain --policy <policy> --endpoint <endpoint.json>` to inspect the endpoint classification and the matching policy decision without sending network traffic.
