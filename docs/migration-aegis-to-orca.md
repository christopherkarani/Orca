...
project notes may still call Aegis CLI. This migration note is for repository
...
- `aegis --help` remains available in this repository for compatibility tests.
- Use `orca --help`, `orca doctor`, `orca run`, `orca replay`, and
  `orca redteam` in new documentation and integrations.

## Safety Boundary

This document does not change the Aegis Edge boundary. Edge evidence remains
